...
Route::get('/edit{id}',[AssetController::class, 'edit'])
    ->middleware(['auth'])->name('edit-customer');

Route::post('/updateClient',[AssetController::class, 'update'])
    ->middleware(['auth'])->name('updateClient');
